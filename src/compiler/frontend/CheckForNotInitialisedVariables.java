...
public class CheckForNotInitialisedVariables {
    public static void checkForNotInitialisedVariables(latte.Absyn.Prog AST) {
                                ...
                                public Void visit(Function p, Void arg) {
                                    ...
                                    for(var argument : p.listarg_) {
                                        ...
                                        if (argumentNamesSet.contains(ident)){
                                            throw new compiler.frontend.LatteError(String.format("Found duplicated function argument %s", ident),
